...
public class D_pelanggan extends javax.swing.JFrame {
    ...
    public void AutoKode(){
           try{
                rs = conn.createStatement().executeQuery("SELECT pelanggan.kd_pelanggan, pelanggan.nama_pelanggan, pelanggan.alamat, pelanggan.jenis_kelamin FROM pelanggan JOIN login ON pelanggan.id = login.id WHERE login.role = 'user';");
                if(rs.next()){
    ...
    public void tampil(){
        try {
            ...
            rs = st.executeQuery("SELECT pelanggan.kd_pelanggan, pelanggan.nama_pelanggan, pelanggan.alamat, pelanggan.jenis_kelamin FROM pelanggan JOIN login ON pelanggan.id = login.id WHERE login.role = 'user';");
            while (rs.next()) {
                Object[] data = {
